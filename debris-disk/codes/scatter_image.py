...
use_compHG = True
def MakeImage(dustfile, d=10, maxa=100., aspect_ratio=1., resolution=0.05, L=1., g=0.5, Ndust=100, obsincl=5., obsazim=0., fixbeta=0., depth=False):
    ...
    #         print(a[i] * (1 - e[i]))
    if depth:
        return image_alt, image_az, col_density, opt_depth #*(1e-4/d/consts.pc2cm)**2/1e-23/4./np.pi #MJy/sr
    else:
